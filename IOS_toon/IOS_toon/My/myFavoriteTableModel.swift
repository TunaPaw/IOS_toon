...
protocol  myFavoriteTableModelProtocol: class {
    func itemDownloaded(items: NSArray)
}

class myFavoriteTableModel {
    var delegate: myFavoriteTableModelProtocol!
    
    var urlPath = "http://127.0.0.1:8080/iosproject/myFavoriteList.jsp"
    func downloadItems(){
